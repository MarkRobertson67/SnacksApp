...
function Reviews() {
  ...
  useEffect(() => {
    axios.get(`${API}/snacks/${id}/reviews`)
      .then((response) => {
  ...
  const handleAdd = (newReview) => {
    axios.post(`${API}/snacks/${id}/reviews`, newReview)
      .then((response) => {
  ...
  const handleDelete = (id) => {
    axios.delete(`${API}/snacks/${id}/reviews/${id}`)
      .then((response) => {
  ...
  const handleEdit = (updatedReview) => {
    axios.put(`${API}/snacks/${id}/reviews/${updatedReview.id}`, updatedReview)
      .then((response) => {
        const copyReviewArray = [...reviews];
